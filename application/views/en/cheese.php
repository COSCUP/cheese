...
function openAbout(){
	...
	$("#desc").html("<p><img src='"+img_url+"coscup.png'/></p><p><b>COSCUP Cheese</b>, a platform that makes sharing photo about COSCUP easy, is launched by Marketing Team of COSCUP 2011. The word \"Cheese\" refers that we are delicated in intensifying the bonding between all attending members of COSCUP. Also, we look forward to your saying Cheese when taking photo in COSCUP.</p><p>The COSCUP Cheese project is mainly leading by lRabbit and Toby, in associate with all Marketing members, including Captain BobChao, CodePecker Illustrator Mini, Assistant Singing, and Advisors ShiaShia, Yinguichen. Special thanks to the leading of Website Team, Timdream, and other advisors. </p><p>For more information about COSCUP, Conference for Open Source Coders, Users, and Promoters, please pay a visit to COSCUP official website.</p>");
...
<div id="getInvolvedInfo"><p>It's easy to get involved! Just <a href="http://picasaweb.google.com" target="_blank" style="color:#FFF">upload your Cheese photo in COSCUP to Picasa</a> and tag it with #COSCUP2010, then it will automatically mix up with COSCUP Cheese.</p><p>Also, you can rate others' Cheese photo with Google +1 button.</p><p>*Notice that the photo you uploaded sometimes may not appear due to the limited amount of photo.</p><div class='select_option' style='clear: both;text-align: center;width: 80px; margin-top: 20px' onclick='closeGetInvolved();'>Close</div></div>
